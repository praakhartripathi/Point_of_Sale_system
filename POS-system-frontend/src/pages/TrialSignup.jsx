        ...
        <div className="bg-card text-card-foreground rounded-xl shadow-lg p-6 border">
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4 text-xs text-muted-foreground">
              By signing up, you agree to our <a href="#" className="underline hover:text-primary">Terms</a> and <a
              href="#" className="underline hover:text-primary">Privacy Policy</a>.
            </div>
