      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto py-6 px-3 space-y-1">
          {menuItems.map((item) => (
            ...
            >
              <div className={`shrink-0 ${activeItem === item.id ? "text-indigo-600" : "text-gray-400 group-hover:text-gray-600"}`}>
        ...
        <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-8 sticky top-0 z-10 shadow-sm">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="h-9 w-9 rounded-full bg-indigo-100 text-indigo-600 flex items-center justify-center font-bold border border-indigo-200">
                SA
              </div>
            </div>
          </div>
          ...
          {activeItem === "Dashboard" ? (
            <div className="max-w-7xl mx-auto space-y-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                ...
                <div className="space-y-6">
                  {[
                    { title: "New Store Registered", desc: "Fresh Mart has successfully registered.", time: "2 hours ago", icon: <Store />, color: "bg-blue-50 text-blue-600" },
                    { title: "Subscription Upgraded", desc: "Tech Zone upgraded to Pro Plan.", time: "5 hours ago", icon: <CreditCard />, color: "bg-green-50 text-green-600" },
                    { title: "Store Blocked", desc: "Fashion Hub has been blocked due to non-payment.", time: "1 day ago", icon: <XCircle />, color: "bg-red-50 text-red-600" },
                    { title: "New Support Ticket", desc: "Ticket #1023 created by Green Grocers.", time: "1 day ago", icon: <ClipboardList />, color: "bg-orange-50 text-orange-600" },
                  ].map((item, index) => (
            ...
            <div className="flex flex-col items-center justify-center h-full text-center p-12">
              ...
              <p className="text-gray-500 mt-2 max-w-md">
                The <span className="font-semibold text-indigo-600">{activeItem}</span> module is currently being built. Check back later for updates.
              </p>
            </div>
          )}
        </main>
    ...
    <div className="h-full flex flex-col items-center justify-center">
      <div className="relative w-48 h-48 shrink-0">
        <svg viewBox="0 0 100 100" className="transform -rotate-90 w-full h-full">
           ...
           {data.map((item, index) => (
             <circle key={index} cx="50" cy="50" r="40" fill="transparent" stroke={item.color} strokeWidth="20" strokeDasharray={item.dashArray} strokeDashoffset={item.offset} />
           ))}
        </svg>
...
const StoresView = () => {
  const stores = [
    { id: 1, name: "Fresh Mart", owner: "John Doe", email: "john@freshmart.com", phone: "+91 98765 43210", plan: "Pro", status: "Active", lastUpdated: "2 hours ago", registeredOn: "Oct 12, 2023", branches: 3 },
    { id: 2, name: "Tech Zone", owner: "Jane Smith", email: "jane@techzone.com", phone: "+91 98765 43211", plan: "Basic", status: "Active", lastUpdated: "1 day ago", registeredOn: "Sep 28, 2023", branches: 1 },
    { id: 3, name: "Fashion Hub", owner: "Mike Ross", email: "mike@fashionhub.com", phone: "+91 98765 43212", plan: "Advance", status: "Blocked", lastUpdated: "Oct 20, 2023", registeredOn: "Aug 15, 2023", branches: 5 },
    { id: 4, name: "Green Grocers", owner: "Sarah Green", email: "sarah@greengrocers.com", phone: "+91 98765 43213", plan: "Pro", status: "Pending", lastUpdated: "Just now", registeredOn: "Nov 01, 2023", branches: 0 },
  ];
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="flex justify-between items-center">
        ...
        <button className="px-4 py-2 bg-indigo-600 text-white rounded-lg text-sm font-medium hover:bg-indigo-700 transition-colors flex items-center gap-2 shadow-sm shadow-indigo-200">
...
const PlansView = () => {
  ...
  const plans = [
    { name: "Basic", price: "₹999", duration: "Month", features: ["10 Branches", "Basic Reporting", "Email Support", "5 Users"], color: "bg-white", border: "border-gray-200", btn: "bg-gray-900 text-white hover:bg-gray-800" },
    { name: "Pro", price: "₹2,499", duration: "Month", features: ["50 Branches", "Advanced Analytics", "Priority Support", "Unlimited Users", "API Access"], color: "bg-indigo-50", border: "border-indigo-200", btn: "bg-indigo-600 text-white hover:bg-indigo-700", popular: true },
    { name: "Enterprise", price: "Custom", duration: "Year", features: ["Unlimited Branches", "Dedicated Manager", "Custom Integrations", "SLA", "On-premise Option"], color: "bg-white", border: "border-gray-200", btn: "bg-white text-gray-900 border border-gray-200 hover:bg-gray-50" },
  ];
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {plans.map((plan, idx) => (
          <div key={idx} className={`rounded-2xl p-8 border transition-all duration-200 ${
            ...
            {plan.popular && (
              <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-indigo-600 text-white px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wide shadow-sm">
                Most Popular
              </div>
            )}
            ...
            <div className="mt-8 pt-6 border-t border-gray-200/50 flex gap-3">
              ...
              <button className="p-2.5 rounded-lg border border-gray-200 text-gray-400 hover:text-red-600 hover:bg-red-50 transition-colors">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {["Stores Data", "Revenue Reports", "User Logs"].map((item, i) => (
          <div key={i} className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 flex flex-col items-start">
            ...
            <p className="text-sm text-gray-500 mt-1 mb-6">Export complete {item.toLowerCase()} in CSV or PDF format.</p>
            <button className="w-full py-2 border border-gray-200 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors flex items-center justify-center gap-2">
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input type="text" defaultValue="POS Pro System" className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Support Email</label>
              <input type="email" defaultValue="support@pos-system.com" className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500" />
            </div>
          </div>
        </div>
...
const Download = (props) => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" /><polyline points="7 10 12 15 17 10" /><line x1="12" x2="12" y1="15" y2="3" /></svg>;
...
const Shield = (props) => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10" /></svg>;
...
const Plus = (props) => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M5 12h14" /><path d="M12 5v14" /></svg>;
...
const Check = (props) => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><polyline points="20 6 9 17 4 12" /></svg>;
...
const Lock = (props) => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect width="18" height="11" x="3" y="11" rx="2" ry="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" /></svg>;
