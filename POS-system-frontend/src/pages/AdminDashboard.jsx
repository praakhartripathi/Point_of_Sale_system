          ...
          {activeItem === "Dashboard" ? (
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-between items-center bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                <div className="flex flex-wrap items-center gap-4">
                  ...
                  <div className="relative">
                    ...
                    <select className="pl-10 pr-8 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-green-500/20 appearance-none cursor-pointer text-gray-700">
                ...
                {/* Reset Filter */}
                <button className="flex items-center gap-2 text-red-600 hover:text-red-700 font-medium text-sm px-4 py-2 hover:bg-red-50 rounded-lg transition-colors">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-left text-sm">
                    ...
                    <tbody className="divide-y divide-gray-100">
                      {[
                        { name: "Monthly Sales Report", type: "Sales", period: "Oct 2023", generated: "Nov 01, 2023", status: "Ready" },
                        { name: "Inventory Summary", type: "Inventory", period: "Q3 2023", generated: "Oct 15, 2023", status: "Ready" },
                        { name: "Employee Performance", type: "HR", period: "Sep 2023", generated: "Oct 01, 2023", status: "Archived" },
                        { name: "Tax Report", type: "Financial", period: "FY 2022-23", generated: "Sep 20, 2023", status: "Ready" },
                      ].map((report, index) => (
                        <tr key={index} className="hover:bg-gray-50 transition-colors">
                          ...
                          <td className="px-6 py-4 text-right">
                            <button className="text-gray-400 hover:text-green-600 transition-colors" title="Download Report">
            ...
            <div className="space-y-8">
              <div className="bg-green-50 border border-green-200 rounded-xl p-6 flex flex-col md:flex-row items-center justify-between gap-4 shadow-sm">
                <div>
                  ...
                  <div className="flex flex-wrap items-center gap-4 mt-2 text-sm">
                    ...
                    <div className="flex items-center gap-2">
                       ...
                       <span className="bg-green-200 text-green-800 px-2 py-0.5 rounded-full text-xs font-bold uppercase tracking-wider">Active</span>
                    </div>
                    <div className="hidden sm:block w-px h-4 bg-green-300"></div>
                    <div className="flex items-center gap-2">
                ...
                <button className="px-6 py-2.5 bg-white text-green-700 border border-green-200 rounded-lg font-semibold text-sm hover:bg-green-50 transition-colors shadow-sm">
                  Manage Billing
                </button>
              </div>
              ...
              <div className="text-center max-w-2xl mx-auto mb-12">
                ...
                <p className="text-gray-500 mt-2">Scale your POS system as your business grows. Upgrade or downgrade at any time.</p>
              </div>
              
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                {/* Basic Plan */}
                <div className={`rounded-2xl p-8 transition-all duration-300 relative ${
                  currentPlan === "Basic" 
                  ...
                  {currentPlan === "Basic" && (
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-green-500 text-white px-4 py-1 rounded-full text-sm font-bold shadow-sm">
                      Your Plan
                    </div>
                  )}
                  ...
                  <button
                    ...
                    className={`w-full py-3 px-4 font-semibold rounded-xl transition-colors mb-8 ${
                      currentPlan === "Basic"
                  ...
                  <div className="space-y-4">
                    <FeatureItem text="10 Branches" icon={<Store className={`w-5 h-5 ${currentPlan === "Basic" ? "text-green-600" : "text-gray-400"}`} />} highlight={currentPlan === "Basic"} />
                    <FeatureItem text="50 Users" icon={<Users className={`w-5 h-5 ${currentPlan === "Basic" ? "text-green-600" : "text-gray-400"}`} />} highlight={currentPlan === "Basic"} />
                    <FeatureItem text="1,000 Products" icon={<Package className={`w-5 h-5 ${currentPlan === "Basic" ? "text-green-600" : "text-gray-400"}`} />} highlight={currentPlan === "Basic"} />
                ...
                <div className={`rounded-2xl p-8 transition-all duration-300 relative ${
                  ...
                  <div className="space-y-4">
                    <FeatureItem text="100 Branches" icon={<Store className={`w-5 h-5 ${currentPlan === "Pro" ? "text-green-600" : "text-gray-400"}`} />} highlight={currentPlan === "Pro"} />
                    <FeatureItem text="500 Users" icon={<Users className={`w-5 h-5 ${currentPlan === "Pro" ? "text-green-600" : "text-gray-400"}`} />} highlight={currentPlan === "Pro"} />
                    <FeatureItem text="9,000 Products" icon={<Package className={`w-5 h-5 ${currentPlan === "Pro" ? "text-green-600" : "text-gray-400"}`} />} highlight={currentPlan === "Pro"} />
                ...
                <div className={`rounded-2xl p-8 transition-all duration-300 relative ${
                  ...
                  <div className="space-y-4">
                    <FeatureItem text="400 Branches" icon={<Store className={`w-5 h-5 ${currentPlan === "Advance" ? "text-green-600" : "text-gray-400"}`} />} highlight={currentPlan === "Advance"} />
                    <FeatureItem text="5,000 Users" icon={<Users className={`w-5 h-5 ${currentPlan === "Advance" ? "text-green-600" : "text-gray-400"}`} />} highlight={currentPlan === "Advance"} />
                    <FeatureItem text="50,000 Products" icon={<Package className={`w-5 h-5 ${currentPlan === "Advance" ? "text-green-600" : "text-gray-400"}`} />} highlight={currentPlan === "Advance"} />
                  ...
                  {["General", "Security", "Notifications"].map((tab) => (
                    <button
                      ...
                      className={`px-6 py-4 text-sm font-medium whitespace-nowrap transition-colors relative ${
                        settingsTab === tab ? "text-green-600 bg-green-50/50" : "text-gray-600 hover:bg-gray-50"
                      }`}
                    >
                      {tab}
                      {settingsTab === tab && (
                  ...
                  {settingsTab === "General" && (
                    <div className="space-y-6">
                      <div className="flex items-center gap-6">
                        <div className="w-20 h-20 rounded-full bg-gray-100 flex items-center justify-center text-2xl font-bold text-gray-400 border-2 border-dashed border-gray-300">
                          A
                        </div>
                        <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          ...
                          <input type="text" defaultValue="Admin" className="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-green-500/20" />
                        </div>
                        <div>
                          <label className="block text-sm font-medium text-gray-700 mb-2">Last Name</label>
                          <input type="text" defaultValue="User" className="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-green-500/20" />
                        </div>
                        <div>
                          <label className="block text-sm font-medium text-gray-700 mb-2">Email Address</label>
                          <input type="email" defaultValue="admin@pos-system.com" className="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-green-500/20" />
                        </div>
                        <div>
                          <label className="block text-sm font-medium text-gray-700 mb-2">Phone Number</label>
                          <input type="tel" defaultValue="+91 98765 43210" className="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-green-500/20" />
                        </div>
                      </div>

                      <div className="pt-4 border-t border-gray-100 flex justify-end">
                        <button className="px-6 py-2 bg-green-600 text-white rounded-lg text-sm font-medium hover:bg-green-700 transition-colors shadow-lg shadow-green-200">
                          Save Changes
                        </button>
                      </div>
                    </div>
                  ...
                  {settingsTab === "Security" && (
                    <div className="max-w-lg space-y-6">
                      <div>
                        ...
                        <input type="password" placeholder="••••••••" className="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-green-500/20" />
                      </div>
                      <div>
      ...
      <div className="flex items-center gap-8 w-full">
        <div className="relative w-40 h-40 shrink-0">
          <svg viewBox="0 0 100 100" className="transform -rotate-90 w-full h-full">
             ...
             <circle cx="50" cy="50" r="40" fill="transparent" stroke="#16a34a" strokeWidth="20" strokeDasharray="88 251" /> 
             <circle cx="50" cy="50" r="40" fill="transparent" stroke="#22c55e" strokeWidth="20" strokeDasharray="63 251" strokeDashoffset="-88" />
             <circle cx="50" cy="50" r="40" fill="transparent" stroke="#4ade80" strokeWidth="20" strokeDasharray="50 251" strokeDashoffset="-151" />
             <circle cx="50" cy="50" r="40" fill="transparent" stroke="#86efac" strokeWidth="20" strokeDasharray="38 251" strokeDashoffset="-201" />
             <circle cx="50" cy="50" r="40" fill="transparent" stroke="#bbf7d0" strokeWidth="20" strokeDasharray="12 251" strokeDashoffset="-239" />
          </svg>
...
const FeatureItem = ({ text, highlight, icon }) => (
  <div className="flex items-center gap-3">
    {icon || (
      <div className={`shrink-0 p-1 rounded-full ${highlight ? "bg-green-100 text-green-600" : "bg-gray-100 text-gray-400"}`}>
