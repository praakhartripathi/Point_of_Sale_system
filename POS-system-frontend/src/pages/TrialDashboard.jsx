                ...
                <div className="px-4 py-3 border-b border-gray-200 dark:border-gray-700">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-bold text-gray-900 dark:text-white">{adminName}</p>
                      <p
                        className="text-xs text-gray-500 dark:text-gray-400">{userEmail || profileData?.email || "Loading..."}</p>
                    </div>
                  </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div
            ...
            <div>
              ...
              <h3
                className={`text-3xl font-bold mt-1 ${isExpired ? 'text-red-600 dark:text-red-400' : 'text-indigo-600 dark:text-indigo-400'}`}>{isExpired ? 'Expired' : 'Trial'}</h3>
            </div>
          ...
          <div
            ...
            <div
              ...
              <button onClick={() => navigate("/pricing")}
                      className="text-xs text-indigo-600 dark:text-indigo-400 font-bold hover:underline">Upgrade to
                Unlock
              </button>
            </div>
