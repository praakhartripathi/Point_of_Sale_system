...
const SignIn = () => {
  ...
  useEffect(() => {
    // Check for error in query params (e.g. from OAuth2 failure redirect)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (token) {
        ...
        // Check if we need to redirect back to a specific page (e.g., Pricing)
  ...
  const handleGoogleLogin = () => {
    console.log("Initiating Google Login redirect to:", `${API_BASE_URL}/oauth2/authorization/google`);
          ...
          <form onSubmit={handleSubmit}>
            ...
            {isSignUp && (
              <div className="mb-4">
                ...
                <div
                  className="flex items-center gap-2 bg-muted/50 px-3 py-2 rounded-lg border focus-within:ring-2 focus-within:ring-primary/20 transition-all">
            ...
            <button type="submit" disabled={loading}
                    className="w-full bg-primary text-primary-foreground py-2 rounded-lg font-medium hover:bg-primary/90 transition disabled:opacity-70">
