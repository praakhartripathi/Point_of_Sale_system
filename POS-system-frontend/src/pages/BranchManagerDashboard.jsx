        ...
        <div className="px-6 py-4 bg-gray-50 dark:bg-gray-800/50 border-b border-gray-100 dark:border-gray-700">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Ambavadi choke near ashoka complex,
                Surat</p>
            </div>
          </div>
        </div>
      ...
      <main className="flex-1 ml-64 p-8 overflow-y-auto h-full">
        <header
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="text-right hidden md:block">
              <p
                className="text-sm font-bold text-gray-900 dark:text-white">{localStorage.getItem("name") || "Branch Manager"}</p>
        ...
        {activeView === "DASHBOARD" ? (
          ...
          <div
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-1">The {activeView.toLowerCase()} module is coming
              soon.</p>
          </div>
        )}
      </main>
