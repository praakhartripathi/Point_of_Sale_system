      ...
      <div className="flex flex-col sm:flex-row items-center gap-8 flex-1 justify-center">
        <div className="relative w-40 h-40 shrink-0">
          <svg viewBox="0 0 100 100" className="transform -rotate-90 w-full h-full">
            ...
            <circle cx="50" cy="50" r="40" fill="none" stroke="#10B981" strokeWidth="20" strokeDasharray="163.36 251.2"
                    className="transition-all duration-1000 ease-out"/>
            {/* 65% */}
            <circle cx="50" cy="50" r="40" fill="none" stroke="#3B82F6" strokeWidth="20" strokeDasharray="62.8 251.2"
                    strokeDashoffset="-163.36" className="transition-all duration-1000 ease-out"/>
            {/* 25% */}
            <circle cx="50" cy="50" r="40" fill="none" stroke="#F59E0B" strokeWidth="20" strokeDasharray="25.12 251.2"
                    strokeDashoffset="-226.16" className="transition-all duration-1000 ease-out"/>
            {/* 10% */}
          </svg>
            ...
            <tr key={i} className="border-b border-gray-50 last:border-0 hover:bg-gray-50 transition-colors">
              ...
              <td className="px-6 py-4 text-right">
                <div className="flex items-center justify-end gap-2">
                  ...
                  <button className="text-gray-400 hover:text-green-600 transition-colors" title="Download Invoice">
                    <Download className="w-5 h-5"/>
                  </button>
                </div>
              </td>
