  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
      ...
      <div className="flex gap-4 h-64">
        {/* Y-Axis */}
        <div className="flex flex-col justify-between items-end text-xs text-gray-400 font-medium pb-6 w-12 shrink-0">
          {yLabels.map((label, i) => (
        ...
        <div
          ...
          {yLabels.map((_, i) => (
            <div key={i} className="absolute w-full border-t border-dashed border-gray-100 dark:border-gray-700/50"
          ...
          {data.map((item, i) => {
            ...
            return (
              <div key={i} className="flex flex-col items-center justify-end h-full w-full gap-2 z-10 group relative">
                <div
        ...
        {data.map((item, index) => (
          <div key={index} className="space-y-2">
            <div className="flex justify-between text-sm">
              ...
              <span className="font-bold text-gray-900 dark:text-white">₹{item.sales.toLocaleString()} <span
                className="text-xs font-normal text-gray-500">({item.percentage}%)</span></span>
            </div>
            ...
            <div className="flex-1 space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <div className="text-right">
                  <span className="font-bold text-gray-900 dark:text-white block">₹{item.sales.toLocaleString()}</span>
                  <span
