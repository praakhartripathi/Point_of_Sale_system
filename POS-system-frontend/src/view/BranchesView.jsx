          ...
          {branches.map(branch => (
            ...
            >
              <div className="flex justify-between items-start mb-4">
                <div
                  className="p-3 bg-green-50 text-green-600 rounded-lg group-hover:bg-green-600 group-hover:text-white transition-colors">
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2
              className="text-2xl font-bold text-gray-900">{viewMode === "ADD" ? "Add New Branch" : formData.name}</h2>
            <p
              className="text-gray-500 text-sm mt-1">{viewMode === "ADD" ? "Enter branch details" : "Manage branch details and configuration"}</p>
          </div>
        </div>
        {!isEditing ? (
          ...
          <div className="flex gap-2">
            ...
            <button onClick={handleSave}
                    className="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors text-sm font-medium shadow-sm shadow-green-200">
              Save Changes
            </button>
          </div>
        )}
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div className="p-8 grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            <h4
              className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-6 border-b border-gray-100 pb-2">Basic
              Information</h4>
            <div className="space-y-6">
              <div className="group">
                <label className="block text-xs font-medium text-gray-500 mb-1.5">Branch Name</label>
                <div
                  className={`flex items-center gap-3 text-gray-900 font-medium p-3 bg-gray-50 rounded-lg border ${isEditing ? 'border-green-500 ring-1 ring-green-500 bg-white' : 'border-gray-100 group-hover:border-gray-200'} transition-all`}>
                  <Store className="w-5 h-5 text-gray-400"/>
                  {isEditing ? (
                    <input type="text" name="name" value={formData.name} onChange={handleChange}
                           className="bg-transparent outline-none w-full" placeholder="e.g. Surat East Branch"/>
                  ) : (
                ...
                <div
                  ...
                  {isEditing ? (
                    <input type="text" name="manager" value={formData.manager} onChange={handleChange}
                           className="bg-transparent outline-none w-full" placeholder="e.g. Rahul Sharma"/>
                  ) : (
                ...
                <div
                  ...
                  {isEditing ? (
                    <input type="text" name="type" value={formData.type} onChange={handleChange}
                           className="bg-transparent outline-none w-full" placeholder="e.g. Retail Outlet"/>
                  ) : (
              ...
              <div className="group">
                ...
                <div
                  className={`flex items-start gap-3 text-gray-900 font-medium p-3 bg-gray-50 rounded-lg border ${isEditing ? 'border-green-500 ring-1 ring-green-500 bg-white' : 'border-gray-100 group-hover:border-gray-200'} transition-all`}>
          ...
          <div>
            <h4
              className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-6 border-b border-gray-100 pb-2">Contact
              & Location</h4>
            <div className="space-y-6">
              <div className="group">
                ...
                <div
                  ...
                  {isEditing ? (
                    <input type="text" name="phone" value={formData.phone} onChange={handleChange}
                           className="bg-transparent outline-none w-full" placeholder="+91..."/>
                  ) : (
                ...
                <div
                  ...
                  {isEditing ? (
                    <input type="email" name="email" value={formData.email} onChange={handleChange}
                           className="bg-transparent outline-none w-full" placeholder="branch@example.com"/>
                  ) : (
              ...
              <div className="group">
                ...
                <div
                  ...
                  {isEditing ? (
                    ...
                    <span
                      className={`px-2 py-0.5 rounded text-xs ${formData.status === "Active" ? "bg-green-100 text-green-700" : "bg-yellow-100 text-yellow-700"}`}>{formData.status}</span>
                  )}
                </div>
              </div>
            </div>
...
const Tag = (props) => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                            strokeLinejoin="round" {...props}>
...
const Phone = (props) => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                              stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                              strokeLinejoin="round" {...props}>
  <path
...
const ArrowLeft = (props) => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                  fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                                  strokeLinejoin="round" {...props}>
  <path d="m12 19-7-7 7-7"/>
  <path d="M19 12H5"/>
</svg>;
const Activity = (props) => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                 fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                                 strokeLinejoin="round" {...props}>
