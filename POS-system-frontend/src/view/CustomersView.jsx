      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div
          ...
          <div>
            ...
            <p
              className="text-2xl font-bold text-purple-600 mt-1">{customers.filter(c => c.loyaltyTier === "Platinum").length}</p>
          </div>
          ...
          <table className="w-full text-left border-collapse">
            ...
            {filteredCustomers.map((cust, i) => (
              <tr key={i}
                ...
                <td
                  className="py-3 px-4 font-medium text-gray-900 dark:text-white">₹{cust.totalSpent.toLocaleString()}</td>
                <td className="py-3 px-4 text-gray-500 dark:text-gray-400">{cust.lastVisit}</td>
                <td className="py-3 px-4">
                                        <span
                                          className={`text-xs px-2 py-1 rounded-full font-medium ${cust.loyaltyTier === "Platinum" ? "bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-400" :
                ...
                <td className="py-3 px-4 text-right flex justify-end gap-2">
                  ...
                  <button onClick={() => handleDeleteClick(cust.id)}
...
const UserPlus = (props) => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                                 stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                                 strokeLinejoin="round" {...props}>
...
const Eye = (props) => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
const Star = (props) => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                             strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
