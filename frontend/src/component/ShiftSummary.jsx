                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto">
                    ...
                    <div
                        ...
                        <div className="space-y-3 text-sm">
                            ...
                            <div className="flex justify-between"><span className="text-gray-500 dark:text-gray-400">Shift Start</span><span
                                className="font-medium text-gray-900 dark:text-white">Aug 29, 2025, 11:47 AM</span>
                            </div>
                            <div className="flex justify-between"><span className="text-gray-500 dark:text-gray-400">Shift End</span><span
                    ...
                    <div
                        ...
                        <div className="space-y-3 text-sm">
                            <div className="flex justify-between"><span className="text-gray-500 dark:text-gray-400">Total Orders</span><span
                                className="font-medium text-gray-900 dark:text-white">2</span></div>
                            <div className="flex justify-between"><span className="text-gray-500 dark:text-gray-400">Total Sales</span><span
                                className="font-medium text-gray-900 dark:text-white">₹9394.00</span></div>
                            <div className="flex justify-between"><span className="text-gray-500 dark:text-gray-400">Total Refunds</span><span
                                className="font-medium text-red-500">-₹6695.00</span></div>
                            <div className="h-px bg-gray-200 dark:bg-gray-700 my-2"></div>
                            <div className="flex justify-between text-base"><span
                                className="font-bold text-gray-900 dark:text-white">Net Sales</span><span
                    ...
                    <div
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    <div
                                        className="p-2 bg-blue-50 dark:bg-blue-900/20 rounded-lg text-blue-600 dark:text-blue-400">
                            ...
                            {[1, 2, 3, 4].map((i) => (
                                <div key={i}
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p className="font-medium text-sm text-gray-900 dark:text-white">Product
                                                Item {i}</p>
