                    ...
                    {activeItem === "Dashboard" ? (
                        <div className="max-w-7xl mx-auto space-y-8">
                            ...
                            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                                <div className="flex items-center justify-between mb-6">
                                    ...
                                    <button className="text-sm font-medium text-indigo-600 hover:text-indigo-700">View
                                        All
                                    </button>
                                </div>
                        ...
                        <div className="flex flex-col items-center justify-center h-full text-center p-12">
                            ...
                            <p className="text-gray-500 mt-2 max-w-md">
                                The <span className="font-semibold text-indigo-600">{activeItem}</span> module is
                                currently being built. Check back later for updates.
                            </p>
                        </div>
                    )}
                </main>
        ...
        <div className="h-full flex flex-col items-center justify-center">
            <div className="relative w-48 h-48 shrink-0">
                <svg viewBox="0 0 100 100" className="transform -rotate-90 w-full h-full">
                    ...
                    {data.map((item, index) => (
                        <circle key={index} cx="50" cy="50" r="40" fill="transparent" stroke={item.color}
                                strokeWidth="20" strokeDasharray={item.dashArray} strokeDashoffset={item.offset}/>
                    ))}
                </svg>
        ...
        <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {["Stores Data", "Revenue Reports", "User Logs"].map((item, i) => (
                    <div key={i}
                         className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 flex flex-col items-start">
                        <div className="p-3 bg-indigo-50 text-indigo-600 rounded-lg mb-4">
                            <FileText className="w-6 h-6"/>
                        </div>
                        <h3 className="font-bold text-gray-900">{item}</h3>
                        <p className="text-sm text-gray-500 mt-1 mb-6">Export complete {item.toLowerCase()} in CSV or
                            PDF format.</p>
                        <button
                ...
                <div className="divide-y divide-gray-200">
                    {[
                        ...
                        <div key={i}
                            ...
                            <button className="text-indigo-600 hover:text-indigo-700 text-sm font-medium">Download
                            </button>
                        </div>
                    ))}
                </div>
