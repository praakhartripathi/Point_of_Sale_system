                    ...
                    {activeItem === "Dashboard" ? (
                        <>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                                <StatCard title="Total Sales" value="₹69,800" change="+0% from last month"
                                          icon={<IndianRupee/>}/>
                        ...
                        subscription?.status !== "ACTIVE" ? (
                            <div className="bg-white p-12 rounded-xl shadow-sm border border-gray-100 text-center">
                                ...
                                <button onClick={() => setActiveItem("Upgrade Plan")}
                                        className="px-6 py-2 bg-green-600 text-white rounded-lg font-medium">View Plans
                                </button>
                            </div>
                        ) : (
                            <div className="space-y-6">
                                ...
                                <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                                    ...
                                    <div className="overflow-x-auto">
                                        <table className="w-full text-left text-sm">
                                            <thead
                                                className="bg-gray-50 text-gray-500 font-medium border-b border-gray-100">
                                            <tr>
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="text-center max-w-2xl mx-auto mb-12">
                                ...
                                <p className="text-gray-500 mt-2">Scale your POS system as your business grows. Upgrade
                                    or downgrade at any time.</p>
                            </div>
                                ...
                                <div className={`rounded-2xl p-8 transition-all duration-300 relative ${
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <FeatureItem text="50,000 Products" icon={<Package
                                            className={`w-5 h-5 ${currentPlan === "Advance" ? "text-green-600" : "text-gray-400"}`}/>}
                                                     highlight={currentPlan === "Advance"}/>
                                        <FeatureItem text="WhatsApp/SMS Integration"
                                                     highlight={currentPlan === "Advance"}/>
                                        <FeatureItem text="Customer Notes & Tags"
                                                     highlight={currentPlan === "Advance"}/>
                                        <FeatureItem text="Delivery Module Integration"
                                                     highlight={currentPlan === "Advance"}/>
                                        <FeatureItem text="Product Bundles & Combos"
                                                     highlight={currentPlan === "Advance"}/>
                                        <FeatureItem text="Expense Management" highlight={currentPlan === "Advance"}/>
                                        <FeatureItem text="Invoice PDF & Print Options"
                                                     highlight={currentPlan === "Advance"}/>
                                        <FeatureItem text="Low Stock Notifications"
                                                     highlight={currentPlan === "Advance"}/>
                                ...
                                <div className="flex border-b border-gray-100 overflow-x-auto">
                                    {["General", "Security", "Notifications"].map((tab) => (
                                        ...
                                        >
                                            ...
                                            {settingsTab === tab && (
                                                <div
                                                    className="absolute bottom-0 left-0 w-full h-0.5 bg-green-600"></div>
                                            )}
                                        </button>
                                    ))}
                                </div>
                                ...
                                <div className="p-6">
                                        ...
                                        <div className="space-y-6">
                                            <div className="flex items-center gap-6">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-gray-500 mt-2">JPG, GIF or PNG. Max size
                                                        of 800K</p>
                                                </div>
                                            </div>
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                <div>
                                                    <label className="block text-sm font-medium text-gray-700 mb-2">First
                                                        Name</label>
                                    ...
                                    {settingsTab === "Security" && (
                                        <div className="max-w-lg space-y-6">
                                            <div>
                                                <label className="block text-sm font-medium text-gray-700 mb-2">Current
                                                    Password</label>
                                                <input type="password" placeholder="••••••••"
                                                       className="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-green-500/20"/>
                                            </div>
                                            <div>
                                                <label className="block text-sm font-medium text-gray-700 mb-2">New
                                                    Password</label>
                                                <input type="password" placeholder="••••••••"
                                                       className="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-green-500/20"/>
                                            </div>
                                            <div>
                                                <label className="block text-sm font-medium text-gray-700 mb-2">Confirm
                                                    New Password</label>
                                                <input type="password" placeholder="••••••••"
                                                       className="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-green-500/20"/>
                                            </div>
                                        ...
                                        <div className="space-y-6">
                                            <div
                                                ...
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <div>
                                                        <h4 className="font-medium text-gray-900">Email
                                                            Notifications</h4>
                                                        <p className="text-xs text-gray-500">Receive daily sales reports
                                                            via email</p>
                                                    </div>
                                                </div>
                                            ...
                                            <div
                                                ...
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <div>
                                                        <h4 className="font-medium text-gray-900">Push
                                                            Notifications</h4>
                                                        <p className="text-xs text-gray-500">Get alerts for low stock
                                                            and new orders</p>
                                                    </div>
                                                </div>
                                                <label className="relative inline-flex items-center cursor-pointer">
                ...
                <div className="relative w-40 h-40 shrink-0">
                    <svg viewBox="0 0 100 100" className="transform -rotate-90 w-full h-full">
                        ...
                        <circle cx="50" cy="50" r="40" fill="transparent" stroke="#22c55e" strokeWidth="20"
                                strokeDasharray="63 251" strokeDashoffset="-88"/>
                        <circle cx="50" cy="50" r="40" fill="transparent" stroke="#4ade80" strokeWidth="20"
                                strokeDasharray="50 251" strokeDashoffset="-151"/>
                        <circle cx="50" cy="50" r="40" fill="transparent" stroke="#86efac" strokeWidth="20"
                                strokeDasharray="38 251" strokeDashoffset="-201"/>
                        <circle cx="50" cy="50" r="40" fill="transparent" stroke="#bbf7d0" strokeWidth="20"
                                strokeDasharray="12 251" strokeDashoffset="-239"/>
                    </svg>
