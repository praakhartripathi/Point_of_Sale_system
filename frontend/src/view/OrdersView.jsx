    ...
    const orders = [
        {
            ...
            paymentMode: "UPI",
            status: "Completed",
            items: [{name: "Cotton Shirt", qty: 1, price: 1200}, {name: "Socks", qty: 1, price: 50}]
        },
        {
            id: "#ORD-8851",
            customer: "Sita Verma",
            ...
            paymentMode: "Cash",
            status: "Completed",
            items: [{name: "Ceramic Mug", qty: 2, price: 225}]
        },
        {
            id: "#ORD-8850",
            customer: "Amit Singh",
            ...
            paymentMode: "Card",
            status: "Refunded",
            items: [{name: "Running Shoes", qty: 1, price: 2800}]
        },
        {
            id: "#ORD-8849",
            customer: "Priya Shah",
            ...
            paymentMode: "UPI",
            status: "Completed",
            items: [{name: "Notebook", qty: 5, price: 100}, {name: "Pen Set", qty: 1, price: 420}]
        },
        {
            id: "#ORD-8848",
            customer: "Vikram Das",
            ...
            paymentMode: "Cash",
            status: "Completed",
            items: [{name: "Key Chain", qty: 1, price: 150}]
        },
        {
            id: "#ORD-8847",
            customer: "Neha Gupta",
            ...
            paymentMode: "Card",
            status: "Completed",
            items: [{name: "Wireless Earbuds", qty: 1, price: 3400}]
        },
        {
            id: "#ORD-8846",
            ...
            paymentMode: "UPI",
            status: "Completed",
            items: [{name: "Graphic T-Shirt", qty: 2, price: 390}]
        },
    ];
