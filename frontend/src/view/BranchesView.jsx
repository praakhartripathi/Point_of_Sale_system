        ...
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div className="p-8 grid grid-cols-1 lg:grid-cols-2 gap-12">
                    {/* Basic Information */}
                    <div>
                        <h4 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-6 border-b border-gray-100 pb-2">Basic
                            Information</h4>
                        <div className="space-y-6">
                            <div className="group">
                                ...
                                <div
                                    ...
                                    {isEditing ? (
                                        <input type="text" name="name" value={formData.name} onChange={handleChange}
                                               ...
                                               placeholder="e.g. Surat East Branch"/>
                                    ) : (
                            ...
                            <div className="group">
                                ...
                                <div
                                    ...
                                    {isEditing ? (
                                        <input type="text" name="manager" value={formData.manager}
                                               onChange={handleChange} className="bg-transparent outline-none w-full"
                    ...
                    {/* Contact Information */}
                    <div>
                        <h4 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-6 border-b border-gray-100 pb-2">Contact
                            & Location</h4>
                        <div className="space-y-6">
                            <div className="group">
