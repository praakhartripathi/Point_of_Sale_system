                    ...
                    <div className="flex items-center gap-3 w-full sm:w-auto">
                        <button onClick={() => {
                            ...
                            setIsModalOpen(true);
                                ...
                                className="flex items-center justify-center gap-2 px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors text-sm font-medium w-full sm:w-auto shadow-sm shadow-green-200">
                        ...
                        {filteredEmployees.map((emp, i) => (
                            <tr key={i}
                                ...
                                <td className="py-3 px-4 text-right flex justify-end gap-2">
                                    <button onClick={() => handleViewClick(emp)}
                                            className="p-2 text-gray-400 hover:text-green-600 hover:bg-green-50 rounded-lg transition-colors"
                                            title="View Details">
                                        <Eye className="w-4 h-4"/>
                                    </button>
                                    <button onClick={() => handleDeleteClick(emp.id)}
