...
INSERT INTO users (full_name, email, password, phone, role, status, store_id, razorpay_customer_id, created_at,
                   updated_at)
VALUES ('Store Admin', 'admin@techworld.com', '$2a$10$8.UnVuG9HHgffUDAlk8qfOuVGkqRkgVdukPxk.So0Ba4r.e8h.e.e',
        '9876543210', 'ROLE_STORE_MANAGER', 'ACTIVE', 1, 'cust_sample123', NOW(), NOW());
...
INSERT INTO trial_accounts (business_name, owner_name, email, mobile, password, plan, start_date, end_date, active,
                            created_at, updated_at)
...
INSERT INTO subscriptions (user_id, plan_type, razorpay_subscription_id, status, start_date, end_date, created_at,
                           updated_at)
...
INSERT INTO testimonials (customer_name, business_name, business_type, rating, testimonial_text, plan_type, is_featured,
                          is_active, created_at, updated_at)
VALUES ('John Doe', 'Coffee Haven', 'Restaurant', 5,
        'The POS system transformed how we manage orders during rush hours. Highly recommended!', 'BUSINESS', TRUE,
        TRUE, NOW(), NOW());

INSERT INTO testimonials (customer_name, business_name, business_type, rating, testimonial_text, plan_type, is_featured,
                          is_active, created_at, updated_at)
VALUES ('Sarah Smith', 'Boutique Trends', 'Retail', 4,
        'Great inventory management features. Customer support is also very responsive.', 'STARTER', TRUE, TRUE, NOW(),
        NOW());

INSERT INTO testimonials (customer_name, business_name, business_type, rating, testimonial_text, plan_type, is_featured,
                          is_active, created_at, updated_at)
VALUES ('Mike Johnson', 'Tech Fix', 'Service', 5, 'Best value for money. The reporting tools are fantastic.',
        'ENTERPRISE', FALSE, TRUE, NOW(), NOW());
